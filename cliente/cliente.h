...
public:
    ...
    explicit Cliente(int id,ColorDuck color,ClienteProtocolo& protocolo,std::vector<Collidable*> collidables,Leaderboard leaderboard,float x_inicial, float y_inicial);
